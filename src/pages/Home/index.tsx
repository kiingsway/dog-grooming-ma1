      ...
      <main className={s.page}>
        ...
        <section className={s.hero} aria-label="Hero">
          <div className={s['hero-inner']}>
            ...
            <div className={s['btn-row']}>
              <Link to="/contact" className={`${s.btn} ${s['btn--white']}`}>
                Book Now
              </Link>
              <Link to="/contact" className={`${s.btn} ${s['btn--outline-white']}`}>
                Get Free Quote
              </Link>
            </div>
          </div>
          ...
          <div className={s.container}>
            ...
            <div className={s['why-grid']}>
              {whyItems.map(({ icon, title, text }) => (
                // <article className={s['why-card']} key={title}>
        ...
        <section className={s.cta} aria-labelledby="cta-heading">
          <div className={s['cta-inner']}>
            ...
            <div className={s['btn-row']}>
              <Link to="/contact" className={`${s.btn} ${s['btn--white']}`}>Book Now</Link>
              <Link to="/contact" className={`${s.btn} ${s['btn--outline-white']}`}>Get Free Quote</Link>
            </div>
          </div>
        </section>
